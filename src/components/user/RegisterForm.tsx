  ...
  const onSubmit = handleSubmit(async (data: RegisterUserFields) => {
    ...
    if (response.data?.statusCode === StatusCode.BAD_REQUEST) {
      ...
      if (loginResponse.data?.statusCode === StatusCode.BAD_REQUEST) {
        ...
        const fileResponse = await API.uploadAavatar(
          formData,
      ...
      <Form className="register-form" onSubmit={onSubmit}>
        <Form.Group className="d-flex flex-column justify-content-center align-items-center">
          <FormLabel htmlFor="avatar" id="avatar-p">
            <Avatar round src={preview as string} alt="Avatar"></Avatar>
          </FormLabel>
          <input
        ...
        <Controller
          ...
          render={({ field }) => (
            <Form.Group className="mb-3">
              <FormLabel htmlFor="confirm_password">Confirm_password</FormLabel>
        ...
        <div className="d-flex justify-content-between algin-item-center mb-2">
